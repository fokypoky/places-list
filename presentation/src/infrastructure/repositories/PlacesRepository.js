class PlacesRepository {
    constructor(connectionUrl='http://localhost:6800/api') {
    ...
    async addPlace(place) {
        const response = await this.getResponse(`places?title=${place.Title}&description=${place.Description}&visitDate=${place.VisitDate}`, 'POST');
        return response;
    }
